jQuery(function(r) {
    ...
    function i() {
        ...
        }).then(o.success)["catch"](e => o.error())
    }
    if (t) {
        var e = null;
        r(document.body).on("wc_fragment_refresh updated_wc_div", function() {
            ...
            null !== o && o !== undefined && "" !== o || a(), sessionStorage.setItem(wc_cart_fragments_params.fragment_name, JSON.stringify(t)), s(r)
            ...
            n === e.originalEvent.key && localStorage.getItem(n) !== sessionStorage.getItem(n) && i()
        ...
        try {
            ...
            if (null !== m && m !== undefined && "" !== m || (m = ""), null !== _ && _ !== undefined && "" !== _ || (_ = ""), m && (null === g || g === undefined || "" === g)) throw "No cart_created";
            if (g) {
                var d = +g + 864e5,
                    w = (new Date).getTime();
            ...
            if (!c || !c["div.widget_shopping_cart_content"] || m !== _) throw "No fragment";
